...
const EXERCISES = {
  ...
  Fruits: ["apple", "banana", "grape", "orange", "mango", "papaya", "pear", "plum", "kiwi", "melon"],
...
function App() {
  ...
  const checkAnswer = () => {
    ...
    if (isCorrect) {
      ...
      setShowNext(true); // wrong → show next button
        ...
        <div className="exercise">
          ...
          <div className="left">
            ...
            <div className="controls">
              ...
              {showNext && currentIndex < words.length - 1 && (
                <button onClick={() => {
                  setShowNext(false);
                  setCurrentIndex((i) => i + 1);
                  if (inputRef.current) inputRef.current.focus();
